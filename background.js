...
chrome.contextMenus.create({
    ...
    contexts: ["selection"],
    onclick: function(info) {
        chrome.tabs.create({url: "https://open.spotify.com/search/results/" + info.selectionText.trim()})
    }
});
...
chrome.contextMenus.create({
    ...
    contexts: ["selection"],
    onclick: function(info) {
        chrome.tabs.create({url: "https://store.steampowered.com/search/?term=" + info.selectionText.trim().replace(/\s+/g, "+") + "&s=all"})
    }
});
...
chrome.contextMenus.create({
    ...
    contexts: ["selection"],
    onclick: function(info) {
        chrome.tabs.create({url: "https://stackoverflow.com/search?q=" + info.selectionText.trim().replace(/\s+/g, "+")})
    }
});
